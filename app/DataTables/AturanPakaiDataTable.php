...
class AturanPakaiDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('#', function ($item) {
                $editRoute = route('aturan-pakai.update', $item->uuid);
                $deleteRoute = route('aturan-pakai.destroy', $item->uuid);
    ...
    public function query(AturanPakai $model): QueryBuilder
    {
    ...
    {
        return 'AturanPakai_' . date('YmdHis');
    }
}
