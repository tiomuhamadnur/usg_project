...
class DosisDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('#', function ($item) {
                $editRoute = route('dosis.update', $item->uuid);
                $deleteRoute = route('dosis.destroy', $item->uuid);
    ...
    public function query(Dosis $model): QueryBuilder
    {
