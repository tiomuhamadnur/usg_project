            ...
            <div class="modal-content">
                <form action="{{ route('diskon.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required">Tanggal masa berlaku</label>
                ...
                <form id="editForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row align-items-center g-2">
                                <div class="col">
                                    <input class="form-control" type="date" name="tanggal_awal" id="tanggal_awal_edit" required>
                                </div>
                                <div class="col-auto">
                                    <span class="form-text">s/d</span>
                                </div>
                                <div class="col">
                                    <input class="form-control" type="date" name="tanggal_akhir" id="tanggal_akhir_edit" required>
                                </div>
                            </div>
                        </div>
                    </div>
