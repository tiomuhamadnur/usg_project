...
<html lang="en">
    ...
    <body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
        ...
        <div
            ...
            <!-- ICON -->
            <i class="fa-solid fa-ban text-red-600 text-8xl mb-8"></i>

            <h1 class="text-8xl font-black text-gray-900 mb-3 tracking-tighter">401</h1>
            <h2 class="text-3xl font-bold text-red-600 mb-4 uppercase tracking-wider">Akses Ditolak</h2>

            <p class="text-gray-600 mb-10 text-lg leading-relaxed">
                Anda tidak memiliki otorisasi untuk melakukan request ini.
            </p>
