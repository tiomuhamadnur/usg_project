...
<html lang="en">
    ...
    <body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
        ...
        <div
            ...
            <!-- ICON -->
            <i class="fa-solid fa-triangle-exclamation text-yellow-600 text-8xl mb-8"></i>

            <h1 class="text-8xl font-black text-gray-900 mb-3 tracking-tighter">403</h1>
            <h2 class="text-3xl font-bold text-yellow-600 mb-4 uppercase tracking-wider">Akses Dilarang</h2>
